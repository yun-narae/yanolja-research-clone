            ...
            <div className="flex flex-col w-full px-[26px] pt-9 pb-[65px] laptop:px-[88px] laptop:pt-[52px] laptop:pb-[95px] bg-(--color-text-primary) text-white">
                <div className="flex flex-col tablet:flex-row tablet:items-start tablet:justify-between">
                    ...
                    <div className="flex flex-col tablet:pr-8">
                        ...
                        {/* 개인정보 처리방침 */}
                        <ul aria-label="푸터 링크" className="flex flex-col py-[5px] opacity-[0.45]">
                        ...
                        <ul className="flex flex-wrap items-center gap-x-2.5 py-[5px] text-white opacity-[0.45]">
                            {/* Compliance 정보 */}
                            <li className="text-[0.875rem] font-light text-(--color-yellow-2)">
                                <a
                        ...
                        {/* 저작권 */}
                        <p className="py-[5px] text-[0.875rem] font-light text-white opacity-[0.45]">
                    ...
                    <div className="relative mt-10 tablet:mt-0">
                        <div className="relative w-fit">
                            <select
                                ...
                                className="relative w-[230px] h-12 px-6 pr-10 rounded-full text-[0.875rem] bg-(--color-gray-dark) text-white appearance-none"
